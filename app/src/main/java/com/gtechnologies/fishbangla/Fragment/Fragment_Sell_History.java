...
import com.gtechnologies.fishbangla.Adapter.Sell_History_Adapter;
 ...
 */
public class Fragment_Sell_History extends Fragment {


    @BindView(R.id.sell_history_recyclerview)
    RecyclerView sellHistoryRecyclerview;
    Unbinder unbinder;

    public Fragment_Sell_History() {
    ...
    Context context;
    GET_LOGIN getLogin;
    private List<Get_Fish_List> historyLists = new ArrayList<>();
    private Sell_History_Adapter historyAdapter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        view = inflater.inflate(R.layout.fragment_fragment__sell__history, container, false);
        ...
        try {
            ...
            font_setup();
            historyAdapter = new Sell_History_Adapter(historyLists, context);
            ...
            sellHistoryRecyclerview.setLayoutManager(mLayoutManager);
            sellHistoryRecyclerview.setAdapter(historyAdapter);
                        ...
                        try {
                            if (response.code() == 200) {
                                ...
                                if (fish_list_Response.size() > 0) {
                                    historyLists.clear();
                                    /*for (Get_Fish_List get_fish_list:fish_list_Response){
